...
public partial class ESalonLjepoteContext : DbContext
{
    ...
    /* protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
         ...
         => optionsBuilder.UseSqlServer("Data Source=localhost; Initial Catalog=eSalonLjepote; user=sa; Password=st123W!a; TrustServerCertificate=True");
    */
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OcjeneProizvoda>()
            .HasOne(k => k.Korisnik)
            .WithMany(kor => kor.OcjeneProizvodas)  
            .HasForeignKey(k => k.KorisnikId);


         modelBuilder.Entity<NarudzbaStavka>()
            .HasKey(ns => ns.NarudzbaStavkaId);
        ...
        modelBuilder.Entity<NarudzbaStavka>()
            .HasOne(ns => ns.Proizvod)
            .WithMany()
            .HasForeignKey(ns => ns.ProizvodId)
            .OnDelete(DeleteBehavior.Cascade);
