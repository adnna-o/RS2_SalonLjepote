    ...
    public static class Data
    {
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Proizvod>().HasData(
                ...
                {
                    ProizvodId = 6017,
                    NazivProizvoda = "Umjetne trepavice",
                    Slika = galerijaSlika,
                    Cijena = 12,
                }
                );
            ...
            modelBuilder.Entity<OcjeneProizvoda>().HasData(
                new OcjeneProizvoda()
                {
                    OcjeneProizvodaId = 3191,
                    KorisnikId = 1002,
                    Opis = "Vrlo dobar",
                    Ocjena = 5,
                    ProizvodId = 6010,
