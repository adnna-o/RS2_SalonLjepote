...
namespace eSalonLjepote.Subscriber
{
    public class EmailService
    {
        ...
        public void SendEmail(string message)
        {
            try
            {
                ...
                string fromMail = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? "testadna.98@gmail.com";
                string password = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "TEST12$test";
